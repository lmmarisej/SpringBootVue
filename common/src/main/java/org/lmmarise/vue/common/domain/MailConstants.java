...
public class MailConstants {
    ...
    public static final String MAIL_QUEUE_NAME = "cxk.mail.queue";
    public static final String MAIL_EXCHANGE_NAME = "cxk.mail.exchange";
    public static final String MAIL_ROUTING_KEY_NAME = "cxk.mail.routing.key";
}
